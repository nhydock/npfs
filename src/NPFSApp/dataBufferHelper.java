...
/**
* NPFSApp/dataBufferHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from npfs.idl
* Wednesday, December 10, 2014 11:09:25 PM EST
*/

abstract public class dataBufferHelper
{
  private static String  _id = "IDL:NPFSApp/dataBuffer:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (NPFSApp.dataBufferHelper.id (), "dataBuffer", __typeCode);
    }
    return __typeCode;
  }
